...
def main():
    ...
    parser.add_argument(
        "--data_dir",
        type=str,
        default="/home/liangtian/project/HALC/coco2014/val2014",
    ...
    parser.add_argument(
        ...
        type=int,
        default=32,
        help="Selected mature layer. Default is 32.",
    )
    ...
    if metric == "chair":
        ...
        chair_json_path = os.path.join(
            output_dir,
            f"{model_name}_{model_type}_{dataset_name}_num_images_{num_images}_chair_results_{args.add}.json",
        )
        ...
        result_path = os.path.join(
            output_dir,
            f"{model_name}_{model_type}_{dataset_name}_num_images_{num_images}_layer_chair_results.txt",
        )
